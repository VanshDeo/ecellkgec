...
const MemberComponent: React.FC<MemberComponentProps> = ({
  ...
  return (
    <div className="flex justify-center px-4">
      <div 
        className="speaker-card relative w-72 h-80 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:shadow-yellow-500/30 border border-gray-200"
  ...
  return (
    <div className="bg-white py-12">
      <div className="overflow-x-hidden w-full hidden text-2xl shad relative">
        <h2 className="flex flex-row max-w-sm md:max-w-max text-center font-bold md:pt-0 uppercase md:w-max relative text-[#F7931E]">
          SPEAKERS
        </h2>
      </div>
      <div className="overflow-x-hidden w-full sm:block shad relative">
        <h2 className="text-center text-5xl font-bold relative text-[#F7931E]">SPEAKERS</h2>
      </div>
      <div className="w-full p-5 text-center flex justify-center items-center">
        <p className="text-center max-w-[1000px]">Meet the visionaries and industry leaders who share their journey, insights, and expertise to empower the next generation of entrepreneurs.</p>
      </div>

      <div className="mt-10">
        <Slider {...sliderSettings} className="lg:mr-[5%] mr-8 ml-8 flex justify-center items-center lg:ml-[5%]">
