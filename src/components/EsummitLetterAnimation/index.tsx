...
export default function EsummitLetterAnimation() {
    const text = "E-SUMMIT";
    const loremText = "E-Summit is the cornerstone event of EGNITION, bringing together aspiring entrepreneurs, industry experts, and startup enthusiasts on a common platform.";
    ...
    const handleScrollToAbout = () => {
        const aboutSection = document.getElementById('esummit-about');
        if (aboutSection) {
